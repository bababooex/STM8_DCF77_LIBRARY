  ...
  27  0006 00            	dc.b	0
  62                     ; 16 void TIM1_setup(void)//dual edge detection
  62                     ; 17 {
  64                     .text:	section	.text,new
  65  0000               _TIM1_setup:
  69                     ; 18     TIM1_DeInit();
  71  0000 cd0000        	call	_TIM1_DeInit
  73                     ; 19     TIM1_TimeBaseInit(160, TIM1_COUNTERMODE_UP, 65535, 0);//10uS
  75  0003 4b00          	push	#0
  ...
  83                     ; 21     TIM1_ICInit(TIM1_CHANNEL_1,
  83                     ; 22                 TIM1_ICPOLARITY_RISING,
  83                     ; 23                 TIM1_ICSELECTION_DIRECTTI,
  83                     ; 24                 TIM1_ICPSC_DIV1, 0);
  85  0013 4b00          	push	#0
  86  0015 4b00          	push	#0
  87  0017 4b01          	push	#1
  88  0019 5f            	clrw	x
  ...
  92                     ; 27     TIM1_ICInit(TIM1_CHANNEL_2,
  92                     ; 28                 TIM1_ICPOLARITY_FALLING,
  92                     ; 29                 TIM1_ICSELECTION_INDIRECTTI,
  92                     ; 30                 TIM1_ICPSC_DIV1, 0);
  94  001f 4b00          	push	#0
  95  0021 4b00          	push	#0
  96  0023 4b02          	push	#2
 ...
 231                     ; 46     uint8_t u =
 231                     ; 47         (signals[21] ? 1 : 0) |
 231                     ; 48         (signals[22] ? 2 : 0) |
 231                     ; 49         (signals[23] ? 4 : 0) |
 231                     ; 50         (signals[24] ? 8 : 0);
 ...
 272                     ; 52     uint8_t t =
 272                     ; 53         (signals[25] ? 1 : 0) |
 272                     ; 54         (signals[26] ? 2 : 0) |
 272                     ; 55         (signals[27] ? 4 : 0);
 ...
 314  0064 81            	ret
 358                     ; 60 static uint8_t getHours(void)
 358                     ; 61 {
 ...
 366                     ; 62     uint8_t u =
 366                     ; 63         (signals[29] ? 1 : 0) |
 366                     ; 64         (signals[30] ? 2 : 0) |
 366                     ; 65         (signals[31] ? 4 : 0) |
 366                     ; 66         (signals[32] ? 8 : 0);
 ...
 407                     ; 68     uint8_t t =
 407                     ; 69         (signals[33] ? 1 : 0) |
 407                     ; 70         (signals[34] ? 2 : 0);
 ...
 439  0057 81            	ret
 483                     ; 75 static uint8_t getDayOfMonth(void)
 483                     ; 76 {
 ...
 491                     ; 77     uint8_t u =
 491                     ; 78         (signals[36] ? 1 : 0) |
 491                     ; 79         (signals[37] ? 2 : 0) |
 491                     ; 80         (signals[38] ? 4 : 0) |
 491                     ; 81         (signals[39] ? 8 : 0);
 ...
 532                     ; 83     uint8_t t =
 532                     ; 84         (signals[40] ? 1 : 0) |
 532                     ; 85         (signals[41] ? 2 : 0);
 ...
 564  0057 81            	ret
 588                     ; 90 static uint8_t getDayOfWeek(void)//bcd conversion not needed
 588                     ; 91 {
 589                     .text:	section	.text,new
 590  0000               L731_getDayOfWeek:
 592  0000 89            	pushw	x
 593       00000002      OFST:	set	2
 596                     ; 92     return (signals[42] ? 1 : 0) |
 596                     ; 93            (signals[43] ? 2 : 0) |
 596                     ; 94            (signals[44] ? 4 : 0);
 ...
 627  0024 85            	popw	x
 628  0025 81            	ret
 672                     ; 97 static uint8_t getMonths(void)
 672                     ; 98 {
 ...
 680                     ; 99     uint8_t u =
 680                     ; 100         (signals[45] ? 1 : 0) |
 680                     ; 101         (signals[46] ? 2 : 0) |
 680                     ; 102         (signals[47] ? 4 : 0) |
 680                     ; 103         (signals[48] ? 8 : 0);
 ...
 743  004a 81            	ret
 787                     ; 111 static uint8_t getYears(void)
 787                     ; 112 {
 ...
 795                     ; 113     uint8_t u =
 795                     ; 114         (signals[50] ? 1 : 0) |
 795                     ; 115         (signals[51] ? 2 : 0) |
 795                     ; 116         (signals[52] ? 4 : 0) |
 795                     ; 117         (signals[53] ? 8 : 0);
 ...
 836                     ; 119     uint8_t t =
 836                     ; 120         (signals[54] ? 1 : 0) |
 836                     ; 121         (signals[55] ? 2 : 0) |
 836                     ; 122         (signals[56] ? 4 : 0) |
 836                     ; 123         (signals[57] ? 8 : 0);
...
1012                     ; 133     for (b = 29; b <= 34; b++) pHour ^= signals[b];
...
1036                     ; 134     for (c = 36; c <= 57; c++) pDate ^= signals[c];
...
1060                     ; 136     if (pMin  != signals[28]) return 0;
...
1070  0053               L703:
1071                     ; 137     if (pHour != signals[35]) return 0;
...
1083  005c 81            	ret
1084  005d               L113:
1085                     ; 138     if (pDate != signals[58]) return 0;
...
1095  0066               L313:
1096                     ; 140     return 1;//correct parity check
1098  0066 a601          	ld	a,#1
1100  0068 20f0          	jra	L242
1147                     ; 143 static void DCF77_ProcessPulse(uint16_t w)
1147                     ; 144 {
...
1156                     ; 146     silenceTicks = 0;
1158  0002 3f05          	clr	_silenceTicks
1159                     ; 148     if (state != DCF_IN_FRAME && state != DCF_SEARCH_SYNC)
...
1167                     ; 149         return;
1169  000e               L143:
1170                     ; 151     if (w >= BIT0_MIN && w < BIT0_MAX)
...
1185  0020               L343:
1186                     ; 153     else if (w >= BIT1_MIN && w < BIT1_MAX)
...
1222  0042 81            	ret
1223  0043               L353:
1224                     ; 167     signals[signalIndex++] = bit;
...
1234                     ; 169     if (signalIndex >= FRAME_BITS)
1236  004f b603          	ld	a,L5_signalIndex
1237  0051 a13b          	cp	a,#59
1238  0053 2504          	jrult	L553
1239                     ; 170         state = DCF_FRAME_READY;
1241  0055 35020004      	mov	L7_state,#2
1242  0059               L553:
1243                     ; 171 }
1245  0059 20e5          	jra	L642
1279                     ; 173 static void DCF77_CommitFrame(void)
1279                     ; 174 {
1280                     .text:	section	.text,new
1281  0000               L753_DCF77_CommitFrame:
1285                     ; 175     if (!DCF77_CheckParity())//correct parity check
1287  0000 cd0000        	call	L122_DCF77_CheckParity
1289  0003 4d            	tnz	a
1290  0004 2605          	jrne	L173
1291                     ; 177         state = DCF_SEARCH_SYNC;
1293  0006 3f04          	clr	L7_state
1294                     ; 178         signalIndex = 0;
1296  0008 3f03          	clr	L5_signalIndex
1297                     ; 179         return;
1300  000a 81            	ret
1301  000b               L173:
1302                     ; 187     lastTimeValue.minutes     = getMinutes();
1304  000b cd0000        	call	L34_getMinutes
1306  000e b700          	ld	L31_lastTimeValue,a
1307                     ; 188     lastTimeValue.hours       = getHours();
1309  0010 cd0000        	call	L76_getHours
1311  0013 b701          	ld	L31_lastTimeValue+1,a
1312                     ; 189 		lastTimeValue.dayOfWeek   = getDayOfWeek();
1314  0015 cd0000        	call	L731_getDayOfWeek
1316  0018 b702          	ld	L31_lastTimeValue+2,a
1317                     ; 190     lastTimeValue.dayOfMonth  = getDayOfMonth();
1319  001a cd0000        	call	L311_getDayOfMonth
1321  001d b703          	ld	L31_lastTimeValue+3,a
1322                     ; 191     lastTimeValue.months      = getMonths();
1324  001f cd0000        	call	L151_getMonths
1326  0022 b704          	ld	L31_lastTimeValue+4,a
1327                     ; 192     lastTimeValue.years       = getYears();
1329  0024 cd0000        	call	L571_getYears
1331  0027 b705          	ld	L31_lastTimeValue+5,a
1332                     ; 194     timeReceived = 1;
1334  0029 35010006      	mov	L11_timeReceived,#1
1335                     ; 196     state = DCF_SEARCH_SYNC;
1337  002d 3f04          	clr	L7_state
1338                     ; 197     signalIndex = 0;
1340  002f 3f03          	clr	L5_signalIndex
1341                     ; 198 }
1344  0031 81            	ret
1372                     ; 200 static void DCF77_Monitor(void)
1372                     ; 201 {
1373                     .text:	section	.text,new
1374  0000               L373_DCF77_Monitor:
1378                     ; 202     if (silenceTicks > THRESHOLD_TICK)   
1380  0000 b605          	ld	a,_silenceTicks
1381  0002 a112          	cp	a,#18
1382  0004 250c          	jrult	L504
1383                     ; 204         state = DCF_SEARCH_SYNC;
1385  0006 3f04          	clr	L7_state
1386                     ; 205         signalIndex = 0;
1388  0008 3f03          	clr	L5_signalIndex
1389                     ; 206         silenceTicks = 0;
1391  000a 3f05          	clr	_silenceTicks
1392                     ; 208         clock_seconds = 59;
1394  000c 353b0042      	mov	_clock_seconds,#59
1395                     ; 209         ms_counter = 0;       
1397  0010 3f45          	clr	_ms_counter
1398  0012               L504:
1399                     ; 212 }
1402  0012 81            	ret
1442                     ; 214 void DCF77_Update(void)
1442                     ; 215 {
1443                     .text:	section	.text,new
1444  0000               _DCF77_Update:
1446  0000 89            	pushw	x
1447       00000002      OFST:	set	2
1450                     ; 216 	  DCF77_Monitor();
1452  0001 cd0000        	call	L373_DCF77_Monitor
1454                     ; 217     if (pulseReady)
1456  0004 3d02          	tnz	_pulseReady
1457  0006 270b          	jreq	L524
1458                     ; 222         w = pulseWidth;
1460  0008 be00          	ldw	x,_pulseWidth
1461  000a 1f01          	ldw	(OFST-1,sp),x
1463                     ; 223         pulseReady = 0;
1465  000c 3f02          	clr	_pulseReady
1466                     ; 226         DCF77_ProcessPulse(w);
1468  000e 1e01          	ldw	x,(OFST-1,sp)
1469  0010 cd0000        	call	L513_DCF77_ProcessPulse
1471  0013               L524:
1472                     ; 228     if (state == DCF_FRAME_READY)
1474  0013 b604          	ld	a,L7_state
1475  0015 a102          	cp	a,#2
1476  0017 2603          	jrne	L724
1477                     ; 230         DCF77_CommitFrame();
1479  0019 cd0000        	call	L753_DCF77_CommitFrame
1481  001c               L724:
1482                     ; 232 }
1485  001c 85            	popw	x
1486  001d 81            	ret
1511                     ; 234 bool DCF77_GetTime(void)
1511                     ; 235 {
1512                     .text:	section	.text,new
1513  0000               _DCF77_GetTime:
1517                     ; 236     if (timeReceived)
1519  0000 3d06          	tnz	L11_timeReceived
1520  0002 2705          	jreq	L144
1521                     ; 238         timeReceived = 0;
1523  0004 3f06          	clr	L11_timeReceived
1524                     ; 239         return 1;
1526  0006 a601          	ld	a,#1
1529  0008 81            	ret
1530  0009               L144:
1531                     ; 241     return 0;
1533  0009 4f            	clr	a
1536  000a 81            	ret
1623                     ; 245 void DCF77_ReadTime(DCF77_dateTime_t *out)
1623                     ; 246 {
1624                     .text:	section	.text,new
1625  0000               _DCF77_ReadTime:
1629                     ; 248     *out = lastTimeValue;
1631  0000 90ae0000      	ldw	y,#L31_lastTimeValue
1632  0004 a606          	ld	a,#6
1633  0006 cd0000        	call	c_xymov
1635                     ; 250 }
1638  0009 81            	ret
1671                     ; 253 void DCF77_Init(void)
1671                     ; 254 {
1672                     .text:	section	.text,new
1673  0000               _DCF77_Init:
1677                     ; 255     signalIndex = 0;
1679  0000 3f03          	clr	L5_signalIndex
1680                     ; 256     state = DCF_SEARCH_SYNC;
1682  0002 3f04          	clr	L7_state
1683                     ; 257 		clock_seconds= 0;
1685  0004 3f42          	clr	_clock_seconds
1686                     ; 258 		ms_counter = 0;
1688  0006 3f45          	clr	_ms_counter
1689                     ; 259 		clock_ms_counter=0;
1691  0008 5f            	clrw	x
1692  0009 bf43          	ldw	_clock_ms_counter,x
1693                     ; 260     silenceTicks = 0;
1695  000b 3f05          	clr	_silenceTicks
1696                     ; 261     timeReceived = 0;
1698  000d 3f06          	clr	L11_timeReceived
1699                     ; 262 		TIM4_setup();
1701  000f cd0000        	call	_TIM4_setup
1703                     ; 263 		TIM1_setup();
1705  0012 cd0000        	call	_TIM1_setup
1707                     ; 264 		enableInterrupts();
1710  0015 9a            rim
1712                     ; 265 }
1716  0016 81            	ret
1860                     	switch	.ubsct
1861  0000               L31_lastTimeValue:
1862  0000 000000000000  	ds.b	6
1863  0006               L3_signals:
1864  0006 000000000000  	ds.b	60
1865                     	xdef	_TIM1_setup
1866                     	xdef	_TIM4_setup
1867                     	xdef	_DCF77_ReadTime
1868                     	xdef	_DCF77_GetTime
1869                     	xdef	_DCF77_Update
1870                     	xdef	_DCF77_Init
1871                     	xdef	_pulseReady
1872                     	xdef	_pulseWidth
1873  0042               _clock_seconds:
1874  0042 00            	ds.b	1
1875                     	xdef	_clock_seconds
1876  0043               _clock_ms_counter:
1877  0043 0000          	ds.b	2
1878                     	xdef	_clock_ms_counter
1879                     	xdef	_silenceTicks
1880  0045               _ms_counter:
1881  0045 00            	ds.b	1
1882                     	xdef	_ms_counter
1883                     	xref	_TIM4_ITConfig
1884                     	xref	_TIM4_Cmd
1885                     	xref	_TIM4_TimeBaseInit
1886                     	xref	_TIM4_DeInit
1887                     	xref	_TIM1_ClearFlag
1888                     	xref	_TIM1_ITConfig
1889                     	xref	_TIM1_Cmd
1890                     	xref	_TIM1_ICInit
1891                     	xref	_TIM1_TimeBaseInit
1892                     	xref	_TIM1_DeInit
1893                     	xref.b	c_x
1913                     	xref	c_xymov
1914                     	end
