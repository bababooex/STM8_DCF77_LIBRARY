 ...
 466  0013 1e03          	ldw	x,(OFST-3,sp)
 467  0015 54            	srlw	x
 468  0016 54            	srlw	x
 469  0017 1f05          	ldw	(OFST-1,sp),x
 471                     ; 153   if ((4U * A) >= ((lsifreqkhz - (4U * A)) * (1U + (2U * A))))
 473  0019 1e05          	ldw	x,(OFST-1,sp)
 474  001b 58            	sllw	x
 475  001c 58            	sllw	x
 476  001d 1f01          	ldw	(OFST-5,sp),x
 478  001f 1e03          	ldw	x,(OFST-3,sp)
 479  0021 72f001        	subw	x,(OFST-5,sp)
 480  0024 1605          	ldw	y,(OFST-1,sp)
 481  0026 9058          	sllw	y
 482  0028 905c          	incw	y
 483  002a cd0000        	call	c_imul
 485  002d 1605          	ldw	y,(OFST-1,sp)
 486  002f 9058          	sllw	y
 487  0031 9058          	sllw	y
 488  0033 bf00          	ldw	c_x,x
 489  0035 90b300        	cpw	y,c_x
 490  0038 2509          	jrult	L561
 491                     ; 155     AWU->APR = (uint8_t)(A - 2U);
 493  003a 7b06          	ld	a,(OFST+0,sp)
 494  003c a002          	sub	a,#2
 495  003e c750f1        	ld	20721,a
 497  0041 2006          	jra	L761
 498  0043               L561:
 499                     ; 159     AWU->APR = (uint8_t)(A - 1U);
 501  0043 7b06          	ld	a,(OFST+0,sp)
 502  0045 4a            	dec	a
 503  0046 c750f1        	ld	20721,a
 504  0049               L761:
 505                     ; 161 }
 508  0049 5b06          	addw	sp,#6
 509  004b 81            	ret
 532                     ; 168 void AWU_IdleModeEnable(void)
 532                     ; 169 {
 533                     .text:	section	.text,new
 534  0000               _AWU_IdleModeEnable:
 538                     ; 171   AWU->CSR &= (uint8_t)(~AWU_CSR_AWUEN);
 540  0000 721950f0      	bres	20720,#4
 541                     ; 174   AWU->TBR = (uint8_t)(~AWU_TBR_AWUTB);
 543  0004 35f050f2      	mov	20722,#240
 544                     ; 175 }
 547  0008 81            	ret
 591                     ; 183 FlagStatus AWU_GetFlagStatus(void)
 591                     ; 184 {
 592                     .text:	section	.text,new
 593  0000               _AWU_GetFlagStatus:
 597                     ; 185   return((FlagStatus)(((uint8_t)(AWU->CSR & AWU_CSR_AWUF) == (uint8_t)0x00) ? RESET : SET));
 599  0000 c650f0        	ld	a,20720
 600  0003 a520          	bcp	a,#32
 601  0005 2603          	jrne	L22
 602  0007 4f            	clr	a
 603  0008 2002          	jra	L42
 604  000a               L22:
 605  000a a601          	ld	a,#1
 606  000c               L42:
 609  000c 81            	ret
 644                     	xdef	_TBR_Array
 645                     	xdef	_APR_Array
